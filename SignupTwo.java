...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno){
        ...
        String varEducational[] = {"Non Graduate","Graduate","Post Graduate","Doctrate","Others"};
        educational = new JComboBox(varEducational);
        ...
        String varOccupation[] = {"Salaried","Self Employed","Bussiness","Student","Retired","Others"};
